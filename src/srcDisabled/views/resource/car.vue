    ...
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.carName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.carSerial')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
        <el-select
          ...
          collapse-tags
          value-key="key"
          :placeholder="$t('index.list.carType')"
          clearable
          class="filter-item"
        >
          <el-option
...
export default {
  name: 'Car',
  components: { pagination, carDetails, carEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
