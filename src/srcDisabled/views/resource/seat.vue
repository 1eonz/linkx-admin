    ...
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.seatName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.seatNumber')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
...
import seatEdit from './components/seatEdit'

export default {
  name: 'Seat',
  components: { pagination, seatDetails, seatEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
