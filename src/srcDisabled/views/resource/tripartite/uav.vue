    ...
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.uavName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.uavSerial')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
        <el-select
          ...
          collapse-tags
          value-key="key"
          :placeholder="$t('index.list.uavType')"
          clearable
          class="filter-item"
        >
          <el-option
...
import uavEdit from './../components/uavEdit'

export default {
  name: 'Uavtite',
  components: { pagination, uavDetails, uavEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
