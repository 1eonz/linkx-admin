<template>
  <div class="app-container">
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.tripartiteName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.tripartiteSerial')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
        <el-select
          ...
          collapse-tags
          value-key="key"
          :placeholder="$t('index.list.tripartiteType')"
          clearable
          class="filter-item"
        >
          <el-option
    ...
    <!-- 详情 -->
    <tripartite-details ref="details" />
  </div>
</template>
...
import tripartiteDetails from './../components/tripartiteDetails'
import tripartiteEdit from './../components/tripartiteEdit'

export default {
  name: 'Tripartite',
  components: { pagination, tripartiteDetails, tripartiteEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
