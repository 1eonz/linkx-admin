<template>
  <div class="app-container">
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.conferenceTerminalName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.conferenceTerminalSerial')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
        <el-select
          ...
          collapse-tags
          value-key="key"
          :placeholder="$t('index.list.conferenceTerminalType')"
          clearable
          class="filter-item"
        >
          <el-option
    ...
    <!-- 详情 -->
    <conferenceTerminal-details ref="details" />
  </div>
</template>
...
import conferenceTerminalDetails from '../components/conferenceTerminalDetails'
import conferenceTerminalEdit from '../components/conferenceTerminalEdit'

export default {
  name: 'Tripartite',
  components: { pagination, conferenceTerminalDetails, conferenceTerminalEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
