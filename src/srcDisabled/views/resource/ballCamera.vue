<template>
  <div class="app-container">
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.ballCameraName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.ballCameraSerial')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
        <el-select
          ...
          collapse-tags
          value-key="key"
          :placeholder="$t('index.list.ballCameraType')"
          clearable
          class="filter-item"
        >
          <el-option
    ...
    <!-- 详情 -->
    <ball-camera-details ref="details" />
  </div>
</template>
...
import ballCameraDetails from './components/ballCameraDetails'
import ballCameraEdit from './components/ballCameraEdit.vue'

export default {
  name: 'Recorder',
  components: { pagination, ballCameraDetails, ballCameraEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
