    ...
    >
      ...
      <div class="el-upload__text">
        ...
        <div class="tip-size">
          ...
          <div v-if="type === '1'">
            {{ $t('index.list.uploadSandDrawWidth') }}
          </div>
          <div v-if="type === '2'">
            {{ $t('index.list.uploadVehicleIllusionWidth') }}
          </div>
          <div v-if="type === '3'">
            {{ $t('index.list.uploadLandMarkWidth') }}
          </div>
          <div v-if="type === '4'">
            {{ $t('index.list.uploadWidth') }}
          </div>
        </div>
      </div>
    </el-upload>
...
<script>
import { multipartIcon } from '@/api/resource/plan'
...
export default {
  ...
  methods: {
    ...
    async submitUpload() {
      ...
      await multipartIcon(formData, this.type)
        .then(result => {
