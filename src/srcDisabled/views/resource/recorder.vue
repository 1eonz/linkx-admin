    ...
    <el-card shadow="always" class="card">
      <div class="filter-container">
        <el-input
          ...
          :placeholder="$t('index.list.recorderName')"
          style="width: 200px"
          class="filter-item"
        ...
        <el-input
          ...
          :placeholder="$t('index.list.recorderSerial')"
          style="width: 200px"
          class="filter-item"
          @keyup.enter.native="handleFilter"
        />
        <el-select
          ...
          collapse-tags
          value-key="key"
          :placeholder="$t('index.list.recorderType')"
          clearable
          class="filter-item"
        >
          <el-option
...
import recorderDetails from './components/recorderDetails'
import recorderEdit from './components/recorderEdit'

export default {
  name: 'Recorder',
  components: { pagination, recorderDetails, recorderEdit },
  filters: {
    statusFilter(status) {
      const statusMap = {
        0: 'success',
