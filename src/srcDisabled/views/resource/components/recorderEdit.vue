  ...
  <div>
    ...
    >
      <el-form
        ...
        class="dialog-form"
      >
        <el-form-item :label="$t('index.list.recorderName')" prop="name">
          <el-input v-model.trim="form.name" class="edit-input" />
        </el-form-item>
        <el-form-item :label="$t('index.list.recorderSerial')" prop="code">
        ...
        <el-form-item :label="$t('index.list.recorderType')" prop="typeName">
          <el-popover
            ref="typeListPopover"
          ...
          <el-input
            ...
            :readonly="true"
            class="edit-input"
            :placeholder="$t('index.list.selectRecorderType')"
          />
        </el-form-item>
        <el-form-item
        ...
        <el-form-item :label="$t('index.list.belong')" prop="belong">
          <el-select
            v-model="form.belong"
            class="filter-item"
            style="width: 300px"
            :placeholder="$t('index.list.selectBelong')"
          >
            <el-option
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          v-if="dialogStatus === $t('index.operations.newRecorder')"
          type="primary"
...
export default {
  ...
  data() {
    ...
    const rules = {
      name: [
        {
          required: true,
          message: this.$t('index.messageText.recorderNameCannotBeEmpty'),
          trigger: 'blur'
        }
      ],
      code: [
        {
          required: true,
          message: this.$t('index.list.recorderSerialCannotNull'),
          trigger: 'blur'
        },
      ...
      typeName: [
        {
          required: true,
          message: this.$t('index.messageText.recorderTypeCannotBeEmpty'),
          trigger: 'change'
        }
      ],
      organizationName: [
        {
          required: true,
          message: this.$t('index.list.recorderOrganizationCannotNull'),
          trigger: 'change'
        }
      ]
    }
    return {
      ...
      belongOptions: [
        {
          name: this.$t('index.list.trafficPolice'),
          value: '1001'
        },
        {
          name: this.$t('index.list.patrolman'),
          value: '1002'
        },
        {
          name: this.$t('index.list.SWAT'),
          value: '1003'
        },
        {
          name: this.$t('index.list.policeStation'),
          value: '1004'
        },
        {
          name: this.$t('index.list.localPoliceStation'),
          value: '1005'
        }
      ]
    }
  ...
  methods: {
    add() {
      this.dialogStatus = this.$t('index.operations.newRecorder')
      this.visible = true
      this.getExtendInfo()
    },

    modify({ id }) {
      this.dialogStatus = this.$t('index.operations.recorderEditing')
