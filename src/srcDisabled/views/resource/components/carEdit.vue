  ...
  <div>
    ...
    >
      <el-form
        ...
        class="dialog-form"
      >
        <el-form-item :label="$t('index.list.carName')" prop="name">
          <el-input v-model.trim="form.name" class="edit-input" />
        </el-form-item>
        <el-form-item :label="$t('index.list.carSerial')" prop="code">
        ...
        <el-form-item :label="$t('index.list.carType')" prop="typeName">
          <el-popover
            ref="typeListPopover"
          ...
          <el-input
            ...
            :readonly="true"
            class="edit-input"
            :placeholder="$t('index.list.selectCarType')"
          />
        </el-form-item>
        <el-form-item
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          v-if="dialogStatus === $t('index.operations.newCar')"
          type="primary"
...
export default {
  ...
  data() {
    ...
    const rules = {
      name: [
        {
          required: true,
          message: this.$t('index.messageText.carNameCannotBeEmpty'),
          trigger: 'blur'
        }
      ],
      code: [
        {
          required: true,
          message: this.$t('index.list.carSerialCannotNull'),
          trigger: 'blur'
        },
      ...
      typeName: [
        {
          required: true,
          message: this.$t('index.messageText.carTypeCannotBeEmpty'),
          trigger: 'change'
        }
      ],
      organizationName: [
        {
          required: true,
          message: this.$t('index.list.carOrganizationCannotNull'),
          trigger: 'change'
        }
      ]
    }
  ...
  methods: {
    add() {
      this.dialogStatus = this.$t('index.operations.newCar')
      this.visible = true
      this.getExtendInfo()
    },

    modify({ id }) {
      this.dialogStatus = this.$t('index.operations.carEditing')
