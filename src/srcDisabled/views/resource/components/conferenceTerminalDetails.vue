<template>
  ...
  >
    <el-row>
      <el-col :span="8">
        <template>
          <span>{{ $t('index.list.conferenceTerminalName') }}</span>
        </template>
      </el-col>
      <el-col :span="12">
        <template>
    ...
    <el-row>
      <el-col :span="8">
        <template>
          <span>{{ $t('index.list.conferenceTerminalSerial') }}</span>
        </template>
      </el-col>
      <el-col :span="12">
        <template>
    ...
    <el-row>
      <el-col :span="8">
        <template>
          <span>{{ $t('index.list.conferenceTerminalType') }}</span>
        </template>
      </el-col>
      <el-col :span="12">
        <template>
    ...
    <el-row>
      <el-col :span="8">
        <template>
          <span>{{ $t('index.list.connectedAccount') }}</span>
        </template>
      </el-col>
      <el-col :span="12">
        <template>
    ...
    <el-row>
      <el-col :span="8">
        <template>
          <span>{{ $t('index.list.GbCode') }}</span>
        </template>
      </el-col>
      <el-col :span="12">
        <template>
          <span style="color: blue">{{ form.gbid }}</span>
        </template>
      </el-col>
    </el-row>
    <el-row>
...
<script>
export default {
  name: 'ConferenceTerminalDetails',
  data() {
    return {
      visible: false,
      form: {}
