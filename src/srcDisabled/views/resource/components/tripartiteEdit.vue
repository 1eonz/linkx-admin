  ...
  <div>
    ...
    >
      <el-form
        ...
        class="dialog-form"
      >
        <el-form-item :label="$t('index.list.tripartiteName')" prop="name">
          <el-input v-model.trim="form.name" class="edit-input" />
        </el-form-item>
        <el-form-item :label="$t('index.list.tripartiteSerial')" prop="code">
        ...
        <el-form-item :label="$t('index.list.tripartiteType')" prop="typeName">
          <el-popover
            ref="typeListPopover"
          ...
          <el-input
            ...
            :readonly="true"
            class="edit-input"
            :placeholder="$t('index.list.selectTripartiteType')"
          />
        </el-form-item>
        <el-form-item
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          v-if="dialogStatus === $t('index.operations.newTripartite')"
          type="primary"
...
export default {
  ...
  data() {
    ...
    const rules = {
      name: [
        {
          required: true,
          message: this.$t('index.messageText.tripartiteNameCannotBeEmpty'),
          trigger: 'blur'
        }
      ],
      code: [
        {
          required: true,
          message: this.$t('index.list.tripartiteSerialCannotNull'),
          trigger: 'blur'
        },
      ...
      typeName: [
        {
          required: true,
          message: this.$t('index.messageText.tripartiteTypeCannotBeEmpty'),
          trigger: 'change'
        }
      ],
      organizationName: [
        {
          required: true,
          message: this.$t('index.list.tripartiteOrganizationCannotNull'),
          trigger: 'change'
        }
      ]
    }
  ...
  methods: {
    add() {
      this.dialogStatus = this.$t('index.operations.newTripartite')
      this.visible = true
      this.getExtendInfo()
    },

    modify({ id }) {
      this.dialogStatus = this.$t('index.operations.tripartiteEditing')
