  ...
  <div>
    ...
    >
      <el-form
        ...
        class="dialog-form"
      >
        <el-form-item :label="$t('index.list.uavName')" prop="name">
          <el-input v-model.trim="form.name" class="edit-input" />
        </el-form-item>
        <el-form-item :label="$t('index.list.uavSerial')" prop="code">
        ...
        <el-form-item :label="$t('index.list.uavType')" prop="typeName">
          <el-popover
            ref="typeListPopover"
          ...
          <el-input
            ...
            :readonly="true"
            class="edit-input"
            :placeholder="$t('index.list.selectUAVType')"
          />
        </el-form-item>
        <el-form-item
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          v-if="dialogStatus === $t('index.operations.newUAV')"
          type="primary"
...
export default {
  ...
  data() {
    ...
    const rules = {
      name: [
        {
          required: true,
          message: this.$t('index.messageText.uavNameCannotBeEmpty'),
          trigger: 'blur'
        }
      ],
      code: [
        {
          required: true,
          message: this.$t('index.list.uavSerialCannotNull'),
          trigger: 'blur'
        },
      ...
      typeName: [
        {
          required: true,
          message: this.$t('index.messageText.uavTypeCannotBeEmpty'),
          trigger: 'change'
        }
      ],
      organizationName: [
        {
          required: true,
          message: this.$t('index.list.uavOrganizationCannotNull'),
          trigger: 'change'
        }
      ]
    }
  ...
  methods: {
    add() {
      this.dialogStatus = this.$t('index.operations.newUAV')
      this.visible = true
      this.getExtendInfo()
    },

    modify({ id }) {
      this.dialogStatus = this.$t('index.operations.uavEditing')
