<template>
  <div>
    <el-dialog
      ...
      :title="
        dialogStatus === 'add'
          ? this.$t('index.operations.newBallCamera')
          : this.$t('index.operations.ballCameraEditing')
      "
    ...
    >
      <el-form
        ...
        class="dialog-form"
      >
        <el-form-item :label="$t('index.list.ballCameraName')" prop="name">
          <el-input v-model.trim="form.name" class="edit-input" />
        </el-form-item>
        <el-form-item :label="$t('index.list.ballCameraSerial')" prop="code">
        ...
        <el-form-item :label="$t('index.list.ballCameraType')" prop="typeName">
          <el-popover
            ref="typeListPopover"
          ...
          <el-input
            ...
            :readonly="true"
            class="edit-input"
            :placeholder="$t('index.list.selectBallCameraType')"
          />
        </el-form-item>
        <el-form-item
  ...
  data() {
    ...
    const rules = {
      name: [
        {
          required: true,
          message: this.$t('index.messageText.ballCameraNameCannotBeEmpty'),
          trigger: 'blur',
        },
      ],
      code: [
        {
          required: true,
          message: this.$t('index.list.ballCameraSerialCannotNull'),
          trigger: 'blur',
        },
      ...
      typeName: [
        {
          required: true,
          message: this.$t('index.messageText.ballCameraTypeCannotBeEmpty'),
          trigger: 'change',
        },
      ],
      organizationName: [
        {
          required: true,
          message: this.$t('index.list.ballCameraOrganizationCannotNull'),
          trigger: 'change',
        },
      ],
    }
