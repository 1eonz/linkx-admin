<template>
  <div class="app-container">
    ...
    <!-- 地图资源组织权限 -->
    <set-org ref="org" @success="getList" />
...
import SetDataPermission from './components/setDataPermission.vue'
export default {
  name: 'ImPerson',
  components: {
    pagination,
  ...
  methods: {
    ...
    // 设置数据权限
    async handleDataPermission(row) {
      // this.isShowDataPermission = true
      this.$refs.dataPermission.init(row, this.list)
    },
    // 修改密码
    handleChangePwd(row) {
