  ...
  <div class="task-due-edit-form">
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      <el-form-item label="组织名称">
        <el-input v-model="form.orgName" placeholder="" disabled />
      </el-form-item>
...
export default {
  ...
  data() {
    ...
    // ✅ 在 data() 里直接初始化，子组件 immediate watch 触发时就能拿到数据
    const targetMap = {}
    ...
    return {
      form: {
        id: cloneInitData.id || '',
        orgId: cloneInitData.businessId || '',
        orgName: cloneInitData.businessName || '',
        parentOrgName: cloneInitData.orgName || '',
